...
app_ui = ui.page_fluid(
    ...
    ui.layout_columns(  
        ui.card(
            ...
            ui.p("- The models are trained to minimize point differential error and maximize the underdog win detection rate (recall) on hold out data points"),
